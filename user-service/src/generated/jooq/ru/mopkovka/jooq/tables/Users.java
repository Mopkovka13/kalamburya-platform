 ...
 */
package ru.mopkovka.jooq.tables;
...
import ru.mopkovka.jooq.DefaultSchema;
import ru.mopkovka.jooq.Keys;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>USERS.GOOGLE_SUB</code>.
     */
    public final TableField<UsersRecord, String> GOOGLE_SUB = createField(DSL.name("GOOGLE_SUB"), SQLDataType.VARCHAR(255).nullable(false), this, "");
     ...
     */
    public final TableField<UsersRecord, LocalDateTime> LAST_LOGIN = createField(DSL.name("LAST_LOGIN"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
